        ...
        navigate(dir = 'next') {
            ...
            const animateSlides = () => {
                return new Promise((resolve, reject) => {
                    ...
                    anime({
                        targets: [newSlide.querySelector('.slide__title'), newSlide.querySelector('.slide__desc'), newSlide.querySelector('.slide__desc2'), newSlide.querySelector('.slide__desc3'), newSlide.querySelector('.slide__desc4'), newSlide.querySelector('.slide__link')],
                        duration: this.settings.animation.slides.duration,
                        easing: this.settings.animation.slides.easing,
